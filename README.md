...
| `/admin/schedule`, `/admin/planning`, `/admin/staff/:id` | לו"ז מלווים, לוח ניהול (תיאום מראש), דוח שעות ושכר חודשי |
| `/companion` | אפליקציית מלווה (דורשת התחברות): לו"ז, לפי לקוח, שעות והוצאות |
